...
# 1) Reshape total energy and combine years
total_all <- bind_rows(
...
# 2) Combine renewable detail and compute yearly totals
...
# 3) Join totals with renewables and compute renewable share
...
# 4) Add energy prices (pivot to long and join)
...
# 5) Add EV registrations (2023 only)
energy_combined <- energy_combined |>
...
# 7) Region-year summary for the research question
